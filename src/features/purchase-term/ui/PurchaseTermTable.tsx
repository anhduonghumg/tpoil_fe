...
function nextActionLabel(action: TermNextAction) {
  const map: Record<TermNextAction, string> = {
    ...
    CREATE_ORDER_DOCUMENT: "Đơn đặt hàng",
    CREATE_PAYMENT_REQUEST: "Đề nghị thanh toán",
    CREATE_BANK_INSTRUCTION: "Ủy nhiệm chi",
    MATCH_BANK_TRANSACTION: "Đối chiếu ngân hàng",
    CREATE_RECEIPT: "Giao nhận",
    CALCULATE_ESTIMATE: "Lập giá tạm",
    CALCULATE_TEMP_PRICE: "Lập giá tạm",
    CALCULATE_BILL_NORMALIZE: "Bảng xuất hóa đơn",
    CALCULATE_INVOICE_PRICE: "Bảng xuất hóa đơn",
    CALCULATE_FINAL: "Bảng chính thức",
    CALCULATE_OFFICIAL_FX: "Bảng chính thức",
    CREATE_SETTLEMENT_ADJUSTMENT: "Điều chỉnh/hoàn tiền",
    CREATE_BOSS_SHEET: "Bảng sếp",
